...
from xmcgan.utils import resnet_v1

# CHANGEME: Update to pretrained .npy file.
_DEFAULT_RESNET_PATH = "data/resnet_pretrained.npy"
RESNET_IMG_SIZE = 224
...
def get_pretrained_model(
  ...
  if checkpoint_path is not None:
    ...
    with tf.io.gfile.GFile(checkpoint_path, "rb") as f:
      ...
      state = ModelState(params=checkpoint_data["params"],
